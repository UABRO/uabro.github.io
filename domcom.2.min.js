...
function(){a&&a()})};d.onwindow=function(a,b){window.addEventListener(a,b)};d.branches={names:{},invoked:[],dependencies:{},check:function(a){var b=this.names[a];if(!b)return!1;~this.invoked.indexOf(a)||(this.names[a]=this.get(this.dependencies[a],b,a),this.invoked.push(a));return!0},create:function(a){if(this.names[a])return console.error("branch",a,"already registered");if(2>arguments.length)return console.error("not enough arguments to create branch");var b=arguments[arguments.length-1];if("function"!==
typeof b)return console.error("no init function for branch",a);if(2<arguments.length){if(3<arguments.length)return console.error("too much arguments for creating branch",a);this.dependencies[a]=arguments[1]}this.names[a]=b},get:function(a,b,c){var d=this,e=[],g;if(a)if("string"===typeof a){if(c&&a===c)return console.warn("branch",name,"invoke itself causing infinite recursion. Invocation was skipped");if(!this.check(a))return console.error("branch",a,"not exist before invocation");e.push(this.names[a])}else a.forEach(function(a){if(!g){if(c&&
a===c)return console.warn("branch",a,"invoke itself causing infinite recursion. Invocation was skipped");if(!d.check(a))return g=!0,console.error("branch",a,"not exist before invocation");e.push(d.names[a])}});return g?console.error("branch",name,"invocation failed"):b.apply(b,e)},initialize:function(a,b){var c=this;d.ready(function(){return c.get(a,b)})}};d.DomRules=g;d.Router=m;d.LiveObject=n;d.iterObj=l;d.shared={};d.fshared={};d.live=new d.LiveObject;window.gmtr=k;l({live:{get:function(){return d.live}}},
function(a,b){return Object.defineProperty(window,a,b)});window.DC=d;window.$=document.querySelector.bind(document);window.$$=document.querySelectorAll.bind(document)}else document.addEventListener("DOMContentLoaded",function(){document.body.innerHTML="<h1><b style='color:#000;padding:10px;'>You are using bad browser! What's wrong with you, man!???</b></h1>"})})();