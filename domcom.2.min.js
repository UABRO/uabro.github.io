...
!0)};var q=function(a,b){this.key=a;this.listeners=[];this.liveObject=b};q.prototype.set=function(a){if(this.val!==a)return this.val=a,this.listeners.forEach(function(b){return b(a)}),this};q.prototype.def=function(a){this["default"]=a;return this};q.prototype.then=function(a){this.listeners.push(a);a(this.val||this["default"]||this.liveObject.getDef(this.key));return this};var m=function(){this.storage={};this.defaults={}};m.prototype.get=function(a,b){var c=this.storage[a]||new q(a,this);this.storage[a]||
(this.storage[a]=c);return b?c.then(b):c};m.prototype.set=function(a,b){return this.get(a).set(b)};m.prototype.def=function(a,b){this.defaults[a]=b};m.prototype.getDef=function(a){return this.defaults[a]||this["default"]};var n=function(){var a=this;this.rules=[];d.onwindow("popstate",function(b){return a.checkRules()})};n.prototype.rule=function(a,b){this.rules.push({pattern:a,fn:b})};n.prototype.checkRules=function(a){for(var b=this.rules.length-1;0<=b;--b){var c=this.rules[b];if(location.pathname.match(c.pattern)){c.fn(a);
break}}};n.prototype.go=function(a,b,c){b&&(a+="?",d.iterObj(b,function(b,c){a+=b+"="+c}));history.pushState(null,null,a);this.checkRules(c)};Object.defineProperty(n.prototype,"query",{get:function(){var a=location.search.substr(1).split("&"),b={};if(!a.length||""===a[0])return b;a.forEach(function(a){a=a.split("=");b[a[0].toLowerCase()]=a[1]});return b}});d.model=function(a,b,c){c?c.tag=b:c=b;p[a]=c};d.getModel=function(a){return p[a]};d.getModels=function(){return p};d.from=function(a,b){b=void 0===
...
c.start(),c.css?d("link",{attr:{rel:"stylesheet",href:b+"css/"+f+".css"},events:{load:function(){e()},error:function(a){c.err&&c.err('css for module "'+f+"\" can't be loaded")}}}).into(document.head):e()};c.config=function(a){a.src&&(b=a.src)};return c}();d.Rest=function(){function a(a,b){this._request=a;this._headers=b}function b(a,b,f){var g=this,l=this._request||new XMLHttpRequest;return new Promise(function(h,k){l.open(a,c.base+b);g._headers&&d.iterObj(g._headers,function(a,b){l.setRequestHeader(a,
b)});l.onreadystatechange=function(){if(4===this.readyState){try{var a=JSON.parse(this.responseText)}catch(u){a={}}this.json=a;200===this.status?h(a):k(this)}};for(var r in e)e.hasOwnProperty(r)&&l.setRequestHeader(r,e[r]);"GET"===a?l.send():(l.setRequestHeader("Content-Type","application/json"),l.send(JSON.stringify(f)))})}var c=this,e={};this.base="";var g=function(a){return function(c,d){return b.bind(this)(a,c,d)}};this.get=a.prototype.get=g("GET");this.post=a.prototype.post=g("POST");this.put=
a.prototype.put=g("PUT");this["delete"]=a.prototype["delete"]=g("DELETE");this.patch=a.prototype.patch=g("PATCH");this.setH=function(a,b){return e[a]=b};this.remH=function(a){return delete e[a]};this.headers=function(b){return new a(new XMLHttpRequest,b)};this.xhr=function(b){var c=new XMLHttpRequest;b(c);return new a(c)}};d.ready=function(a){return document.addEventListener("DOMContentLoaded",function(){a&&a()})};d.onwindow=function(a,b){window.addEventListener(a,b)};d.DomRules=g;d.Router=n;d.LiveObject=
m;d.iterObj=h;d.shared={};d.fshared={};d.live=new d.LiveObject;window.gmtr=k;h({live:{get:function(){return d.live}}},function(a,b){return Object.defineProperty(window,a,b)});window.DC=d;window.$=document.querySelector.bind(document);window.$$=document.querySelectorAll.bind(document)}else document.addEventListener("DOMContentLoaded",function(){document.body.innerHTML="<h1><b style='color:#000;padding:10px;'>You are using bad browser! What's wrong with you, man!???</b></h1>"})})();